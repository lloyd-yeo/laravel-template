...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('afu-favicon.jpg') }}">
...
<div id="page-container" class="side-scroll header-navbar-fixed header-navbar-transparent">
        ...
        <div class="content-boxed">
            ...
            <ul class="nav-header pull-right">
                <li class="hidden-md hidden-lg">
                    ...
                    <button class="btn btn-link text-white pull-right"
                            data-toggle="class-toggle"
                            data-target=".js-nav-main-header"
    ...
    <main id="main-container">
        <!-- Hero Content -->
        <div class="bg-image" style="background-image: url('afu-bg.jpg');">
            <div class="bg-primary-dark-op">
                <section class="content content-full content-boxed overflow-hidden">
                    <!-- Section Content -->
                    <div class="push-100-t push-50 text-center">
                        <h1 class="h1 text-white push-10 visibility-hidden"
                            data-toggle="appear" data-class="animated fadeInDown">ALLFORU</h1>
                        <h2 class="h5 text-white-op push-50 visibility-hidden"
                            data-toggle="appear" data-class="animated fadeInDown">Student | Membership | Events</h2>
                        <a class="btn btn-rounded btn-noborder btn-lg btn-primary visibility-hidden"
                           data-toggle="appear" data-class="animated bounceIn" data-timeout="800" href="frontend_pricing.html">SPONSOR MY EVENTS!</a>
                    </div>
                    <div class="row visibility-hidden" data-toggle="appear" data-class="animated fadeInUp">
                        <div class="col-sm-8 col-sm-offset-2">
                            <img class="img-responsive pull-b" src="afu-bg.jpg" alt="">
                        </div>
                    </div>
                    <!-- END Section Content -->
                </section>
